# process_point_service.proto



#### This file was generated from [process_point_service.proto](https://github.com/HiberGlobal/api/blob/master/process_point_service.proto).
...
- Messages
  - [AssignProcessPointDevices](#assignprocesspointdevices)
  - [AssignProcessPointDevices.Request](#assignprocesspointdevicesrequest)
  - [AssignProcessPointDevices.Response](#assignprocesspointdevicesresponse)
  - [AssignProcessPointTags](#assignprocesspointtags)
  - [AssignProcessPointTags.Request](#assignprocesspointtagsrequest)
  - [AssignProcessPointTags.Response](#assignprocesspointtagsresponse)
  - [CreateProcessPoint](#createprocesspoint)
  - [CreateProcessPoint.Request](#createprocesspointrequest)
  - [CreateProcessPoint.Response](#createprocesspointresponse)
  - [DeleteProcessPoint](#deleteprocesspoint)
  - [DeleteProcessPoint.Request](#deleteprocesspointrequest)
  - [DeleteProcessPoint.Response](#deleteprocesspointresponse)
  - [ListProcessPoints](#listprocesspoints)
  - [ListProcessPoints.Request](#listprocesspointsrequest)
  - [ListProcessPoints.Response](#listprocesspointsresponse)
  - [UnassignProcessPointDevices](#unassignprocesspointdevices)
  - [UnassignProcessPointDevices.Request](#unassignprocesspointdevicesrequest)
  - [UnassignProcessPointDevices.Response](#unassignprocesspointdevicesresponse)
  - [UnassignProcessPointTags](#unassignprocesspointtags)
  - [UnassignProcessPointTags.Request](#unassignprocesspointtagsrequest)
  - [UnassignProcessPointTags.Response](#unassignprocesspointtagsresponse)
  - [UpdateProcessPoint](#updateprocesspoint)
  - [UpdateProcessPoint.AddMetadataEntry](#updateprocesspointaddmetadataentry)
  - [UpdateProcessPoint.AddMetadataTextEntry](#updateprocesspointaddmetadatatextentry)
  - [UpdateProcessPoint.Request](#updateprocesspointrequest)
  - [UpdateProcessPoint.Response](#updateprocesspointresponse)

- Enums
  - [ListProcessPoints.Sort](#listprocesspointssort)
...
### List
> **rpc** List([ListProcessPoints.Request](#listprocesspointsrequest))
    [ListProcessPoints.Response](#listprocesspointsresponse)

List the process points in your organization.

### Create
> **rpc** Create([CreateProcessPoint.Request](#createprocesspointrequest))
    [CreateProcessPoint.Response](#createprocesspointresponse)

Create process points in your organization.

### Update
> **rpc** Update([UpdateProcessPoint.Request](#updateprocesspointrequest))
    [UpdateProcessPoint.Response](#updateprocesspointresponse)

Update process points in your organization.

### Delete
> **rpc** Delete([DeleteProcessPoint.Request](#deleteprocesspointrequest))
    [DeleteProcessPoint.Response](#deleteprocesspointresponse)

Delete process points in your organization.

### AssignTag
> **rpc** AssignTag([AssignProcessPointTags.Request](#assignprocesspointtagsrequest))
    [AssignProcessPointTags.Response](#assignprocesspointtagsresponse)

Assign (a) tag(s) to an process point.

### UnassignTag
> **rpc** UnassignTag([UnassignProcessPointTags.Request](#unassignprocesspointtagsrequest))
    [UnassignProcessPointTags.Response](#unassignprocesspointtagsresponse)

Unassign (a) tag(s) from an process point.

### AssignDevice
> **rpc** AssignDevice([AssignProcessPointDevices.Request](#assignprocesspointdevicesrequest))
    [AssignProcessPointDevices.Response](#assignprocesspointdevicesresponse)

Assign (a) device(s) to an process point.

### UnassignDevice
> **rpc** UnassignDevice([UnassignProcessPointDevices.Request](#unassignprocesspointdevicesrequest))
    [UnassignProcessPointDevices.Response](#unassignprocesspointdevicesresponse)
...
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to assign. Not optional and cannot be empty. |
| devices | [ hiber.device.DeviceSelection](#hiberdevicedeviceselection) | Select which devices to assign this process point to. |
...
### AssignProcessPointDevices.Response



| Field | Type | Description |
| ----- | ---- | ----------- |
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ AssignProcessPointDevices.Request](#assignprocesspointdevicesrequest) |  |

### AssignProcessPointTags

Change the assigned tags for a selection of process points in your (selected) organization.


### AssignProcessPointTags.Request
...
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to assign. Not optional and cannot be empty. |
| tags | [ hiber.tag.TagSelection](#hibertagtagselection) | Select which tags to assign this process point to. |
|  **optional** pagination | [optional hiber.Pagination](#hiberpagination) | Paginate through results (for the Response, not the actual update). To get the next pages, use the List call with the same selection and pagination for the next page. |

### AssignProcessPointTags.Response
...
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ AssignProcessPointTags.Request](#assignprocesspointtagsrequest) |  |
...
|  **optional** type | [optional ProcessPoint.Type](#processpointtype) |  |
...
| ----- | ---- | ----------- |
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| create | [repeated CreateProcessPoint](#createprocesspoint) | ProcessPoints to create. |

### CreateProcessPoint.Response



| Field | Type | Description |
| ----- | ---- | ----------- |
| created | [repeated ProcessPoint](#processpoint) |  |
| request | [ CreateProcessPoint.Request](#createprocesspointrequest) |  |
...
| ----- | ---- | ----------- |
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to delete. Not optional and cannot be empty. |

### DeleteProcessPoint.Response
...
| request | [ DeleteProcessPoint.Request](#deleteprocesspointrequest) |  |
...
| ----- | ---- | ----------- |
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
|  **optional** selection | [optional ProcessPointSelection](#processpointselection) | Select which process points to return. Optional, when omitted or empty everything is included. |
|  **optional** pagination | [optional hiber.Pagination](#hiberpagination) | Paginate through results. |
| sort_by | [repeated ListProcessPoints.Sort](#listprocesspointssort) | Sort the process points with the given sort options. |
|  **optional** child_organizations | [optional hiber.Filter.ChildOrganizations](#hiberfilterchildorganizations) | Include process points from the selected child organizations. |

### ListProcessPoints.Response
...
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ ListProcessPoints.Request](#listprocesspointsrequest) |  |

### UnassignProcessPointDevices

Change the assigned devices for a selection of process points in your (selected) organization.


### UnassignProcessPointDevices.Request
...
| ----- | ---- | ----------- |
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to unassign. Not optional and cannot be empty. |
| devices | [ hiber.device.DeviceSelection](#hiberdevicedeviceselection) | Select which devices to unassign this process point from. |
|  **optional** pagination | [optional hiber.Pagination](#hiberpagination) | Paginate through results (for the Response, not the actual update). To get the next pages, use the List call with the same selection and pagination for the next page. |
|  **optional** override_time | [optional hiber.Timestamp](#hibertimestamp) | Time that the assignment ended. This marks the assignment as ended at the given moment in the past, but would not have effect in the past for assignments like parsers and alarms (e.g. no alarm events are removed). It would however work for process points having access to device data. This is not allowed to be a value in the future at the moment. |

### UnassignProcessPointDevices.Response
...
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ UnassignProcessPointDevices.Request](#unassignprocesspointdevicesrequest) |  |

### UnassignProcessPointTags

Change the assigned tags for a selection of process points in your (selected) organization.


### UnassignProcessPointTags.Request
...
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to unassign. Not optional and cannot be empty. |
| tags | [ hiber.tag.TagSelection](#hibertagtagselection) | Select which tags to unassign this process point from. |
|  **optional** pagination | [optional hiber.Pagination](#hiberpagination) | Paginate through results (for the Response, not the actual update). To get the next pages, use the List call with the same selection and pagination for the next page. |

### UnassignProcessPointTags.Response
...
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ UnassignProcessPointTags.Request](#unassignprocesspointtagsrequest) |  |
...
|  **optional** update_type | [optional ProcessPoint.Type](#processpointtype) |  |
...
| add_metadata | [map UpdateProcessPoint.AddMetadataEntry](#updateprocesspointaddmetadataentry) |  |
| add_metadata_text | [map UpdateProcessPoint.AddMetadataTextEntry](#updateprocesspointaddmetadatatextentry) |  |
...
### UpdateProcessPoint.AddMetadataEntry
...
### UpdateProcessPoint.AddMetadataTextEntry
...
| ----- | ---- | ----------- |
|  **optional** organization | [optional string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ProcessPointSelection](#processpointselection) | Select which process points to update. Not optional and cannot be empty. |
| update | [ UpdateProcessPoint](#updateprocesspoint) | The update to apply to the selected process points. |
|  **optional** pagination | [optional hiber.Pagination](#hiberpagination) | Paginate through results (for the Response, not the actual update). To get the next pages, use the List call with the same selection and pagination for the next page. |

### UpdateProcessPoint.Response
...
| process_points | [repeated ProcessPoint](#processpoint) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ UpdateProcessPoint.Request](#updateprocesspointrequest) |  |


## Enums
### ListProcessPoints.Sort


| Name | Description | Number |
| ---- | ----------- | ------ |
| NAME_ASC | Sort alphabetically on the name of the process point, in ascending order. Default. | 0 |
| NAME_DESC | Sort alphabetically on the name of the process point, in descending order. | 1 |
| ACTIVITY | Sort process points on most recent activity first (e.g. newest value received). | 2 |
| INACTIVITY | Sort process points on least recent activity first (e.g. longest no value received). | 3 |
| TYPE_ASC | Sort alphabetically on the process point type, in ascending order. | 4 |
| TYPE_DESC | Sort alphabetically on the process point type, in descending order. | 5 |
