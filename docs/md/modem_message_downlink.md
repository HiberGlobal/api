...
#### This file was generated from [modem_message_downlink.proto](https://github.com/HiberGlobal/api/blob/master/modem_message_downlink.proto).

## Table of Contents

- Services
  - [ModemDownlinkMessageService](#modemdownlinkmessageservice)

- Messages
  - [CreateDownlinkMessages](#createdownlinkmessages)
  - [CreateDownlinkMessages.Request](#createdownlinkmessagesrequest)
  - [CreateDownlinkMessages.Response](#createdownlinkmessagesresponse)
  - [ListDownlinkMessages](#listdownlinkmessages)
  - [ListDownlinkMessages.Request](#listdownlinkmessagesrequest)
  - [ListDownlinkMessages.Response](#listdownlinkmessagesresponse)
  - [ModemDownlinkMessage](#modemdownlinkmessage)
  - [ModemDownlinkMessageSelection](#modemdownlinkmessageselection)
  - [UpdateDownlinkMessagesStatus](#updatedownlinkmessagesstatus)
  - [UpdateDownlinkMessagesStatus.Request](#updatedownlinkmessagesstatusrequest)
  - [UpdateDownlinkMessagesStatus.Response](#updatedownlinkmessagesstatusresponse)

- Enums
  - [ListDownlinkMessages.Sort](#listdownlinkmessagessort)
  - [ModemDownlinkMessage.Status](#modemdownlinkmessagestatus)
...
### List
> **rpc** List([ListDownlinkMessages.Request](#listdownlinkmessagesrequest))
    [ListDownlinkMessages.Response](#listdownlinkmessagesresponse)



### Create
> **rpc** Create([CreateDownlinkMessages.Request](#createdownlinkmessagesrequest))
    [CreateDownlinkMessages.Response](#createdownlinkmessagesresponse)



### UpdateStatus
> **rpc** UpdateStatus([UpdateDownlinkMessagesStatus.Request](#updatedownlinkmessagesstatusrequest))
    [UpdateDownlinkMessagesStatus.Response](#updatedownlinkmessagesstatusresponse)
...
### CreateDownlinkMessages




### CreateDownlinkMessages.Request
...
| messages | [repeated ModemDownlinkMessage](#modemdownlinkmessage) | Downlink messages to send. All ModemDownlinkMessage fields are optional except for modem_number and content. |

### CreateDownlinkMessages.Response



| Field | Type | Description |
| ----- | ---- | ----------- |
| messages | [repeated ModemDownlinkMessage](#modemdownlinkmessage) | The created messages. |

### ListDownlinkMessages




### ListDownlinkMessages.Request
...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ModemDownlinkMessageSelection](#modemdownlinkmessageselection) | none |
| pagination | [ hiber.Pagination](#hiberpagination) | none |
| sort | [ ListDownlinkMessages.Sort](#listdownlinkmessagessort) | none |

### ListDownlinkMessages.Response



| Field | Type | Description |
| ----- | ---- | ----------- |
| messages | [repeated ModemDownlinkMessage](#modemdownlinkmessage) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
| request | [ ListDownlinkMessages.Request](#listdownlinkmessagesrequest) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| identifier | [ string](#string) | Identifier for this downlink message. Unique within the organization. Can be set manually or, if omitted on creation, automatically generated. |
| modem_number | [ string](#string) | The modem number of the device this message should be sent to. |
| body | [ hiber.BytesOrHex](#hiberbytesorhex) | The binary body of the message. |
| metadata | [ google.protobuf.Struct](#googleprotobufstruct) | Any metadata for the message, like fPort for LoRaWAN. |
| status | [ ModemDownlinkMessage.Status](#modemdownlinkmessagestatus) | The status of this message. |
| created_at | [ hiber.Timestamp](#hibertimestamp) | When this downlink message was created. |
| sent_at | [ hiber.Timestamp](#hibertimestamp) | When this downlink message was sent to the device. |
| acknowledged_at | [ hiber.Timestamp](#hibertimestamp) | When this downlink message was acknowledged by the device. |
| acknowledgement_required | [ bool](#bool) | Whether acknowledgement is required, determining when this messages is considered completed. |

### ModemDownlinkMessageSelection

Selection object to select ModemDownlinkMessages.

| Field | Type | Description |
| ----- | ---- | ----------- |
| search | [ string](#string) | Search downlink messages by identifier, modem number, modem tags or metadata |
| identifiers | [repeated string](#string) | Select downlink messages by identifier(s). |
| modems | [ hiber.modem.ModemSelection](#hibermodemmodemselection) | Select modems to list downlink messages for. |
| include_status | [repeated ModemDownlinkMessage.Status](#modemdownlinkmessagestatus) | Select downlink messages that have one of the given statuses. |
| exclude_status | [repeated ModemDownlinkMessage.Status](#modemdownlinkmessagestatus) | Select downlink messages that have none of the given statuses. |
| time_range | [ hiber.TimeRange](#hibertimerange) | Select downlink messages that were created or updated withing the time range. |
| include_completed | [ bool](#bool) | Whether to include downlink messages that have already been sent and acknowledged (if required). |

### UpdateDownlinkMessagesStatus




### UpdateDownlinkMessagesStatus.Request
...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ModemDownlinkMessageSelection](#modemdownlinkmessageselection) | The downlink messages to update. |
| update_status | [ ModemDownlinkMessage.Status](#modemdownlinkmessagestatus) | The new status for the selected messages. |
| pagination | [ hiber.Pagination](#hiberpagination) | Pagination for the downlink messages listed in the response. (All selected messages are updated, regardless of pagination). |

### UpdateDownlinkMessagesStatus.Response



| Field | Type | Description |
| ----- | ---- | ----------- |
| messages | [repeated ModemDownlinkMessage](#modemdownlinkmessage) | The updated messages. |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
| request | [ UpdateDownlinkMessagesStatus.Request](#updatedownlinkmessagesstatusrequest) | none |


## Enums
### ListDownlinkMessages.Sort


| Name | Description | Number |
| ---- | ----------- | ------ |
| DEFAULT | Sort by last change, last changed first. | 0 |
| CREATED_OLDEST_FIRST | Sort by created time, oldest first. | 1 |
| CREATED_NEWEST_FIRST | Sort by created time, newest first. | 2 |
| MODEM_NUMBER | Sort numerically on the number of the modem. | 3 |
| MODEM_NUMBER_INVERTED | Sort numerically on the number of the modem, inverted. | 4 |

### ModemDownlinkMessage.Status


| Name | Description | Number |
| ---- | ----------- | ------ |
| CREATED | Message was created but not sent to the device. | 0 |
| SENT | Message was sent to the device, but not acknowledged. | 1 |
| ACKNOWLEDGED | Message was sent to the device, and acknowledged. | 2 |
