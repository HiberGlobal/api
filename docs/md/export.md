...
#### This file was generated from [export.proto](https://github.com/HiberGlobal/api/blob/master/export.proto).
...
- Messages
  ...
  - [DeleteExport.Request](#deleteexportrequest)
  ...
  - [Export.Format.Csv](#exportformatcsv)
  - [Export.Format.Csv.Column](#exportformatcsvcolumn)
  - [Export.Format.Json](#exportformatjson)
  - [Export.Format.Json.CustomFieldsEntry](#exportformatjsoncustomfieldsentry)
  - [ExportSelection](#exportselection)
  - [ExtendExportDownloadExpiry](#extendexportdownloadexpiry)
  - [ExtendExportDownloadExpiry.Request](#extendexportdownloadexpiryrequest)
  - [ExtendExportDownloadExpiry.Response](#extendexportdownloadexpiryresponse)
  - [ListExports](#listexports)
  - [ListExports.Request](#listexportsrequest)
  - [ListExports.Response](#listexportsresponse)
...
### List
> **rpc** List([ListExports.Request](#listexportsrequest))
    [ListExports.Response](#listexportsresponse)



### Create
> **rpc** Create([CreateExport.Request](#createexportrequest))
    [CreateExport.Response](#createexportresponse)



### AvailableFields
> **rpc** AvailableFields([AvailableFieldsForExport.Request](#availablefieldsforexportrequest))
    [AvailableFieldsForExport.Response](#availablefieldsforexportresponse)



### Extend
> **rpc** Extend([ExtendExportDownloadExpiry.Request](#extendexportdownloadexpiryrequest))
    [ExtendExportDownloadExpiry.Response](#extendexportdownloadexpiryresponse)



### Delete
> **rpc** Delete([DeleteExport.Request](#deleteexportrequest))
    [DeleteExport.Response](#deleteexportresponse)
...
### AvailableFieldsForExport.Request
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| created | [ Export](#export) | none |
| request | [ CreateExport.Request](#createexportrequest) | none |
...
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **type**.modem_message | [ Export.Configuration.ModemMessages](#exportconfigurationmodemmessages) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| type | [ Export.Format.Type](#exportformattype) | none |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **configuration**.json | [ Export.Format.Json](#exportformatjson) | none |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **configuration**.csv | [ Export.Format.Csv](#exportformatcsv) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| custom_fields | [map Export.Format.Json.CustomFieldsEntry](#exportformatjsoncustomfieldsentry) | Custom fields mapping, if a reduced json is desired. |
| compact | [ bool](#bool) | Whether the json should be formatted or as compact as possible. |

### Export.Format.Json.CustomFieldsEntry
...
### ExtendExportDownloadExpiry.Request
...
### ExtendExportDownloadExpiry.Response
...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ ExportSelection](#exportselection) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| exports | [repeated Export](#export) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
| request | [ ListExports.Request](#listexportsrequest) | none |
