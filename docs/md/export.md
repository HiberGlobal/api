...
| request | [ CreateExport.Request](#createexportrequest) |  |
...
### Export.Configuration.ProcessPointValues
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| type | [ Export.Format.Type](#exportformattype) |  |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **configuration**.json | [ Export.Format.Json](#exportformatjson) |  |
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **configuration**.csv | [ Export.Format.Csv](#exportformatcsv) |  |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| exports | [repeated Export](#export) |  |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) |  |
| request | [ ListExports.Request](#listexportsrequest) |  |
