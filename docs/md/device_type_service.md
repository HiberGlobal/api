...
|  **optional** selection | [optional DeviceTypeSelection](#devicetypeselection) | Select which device types to return. Optional, when omitted or empty everything is included. |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| device_types | [repeated DeviceType](#devicetype) |  |
| request | [ ListDeviceTypes.Request](#listdevicetypesrequest) |  |
