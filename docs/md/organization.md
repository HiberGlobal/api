...
| selection | [ OrganizationSelection](#organizationselection) | none |
| pagination | [ hiber.Pagination](#hiberpagination) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| child_organizations | [repeated Organization](#organization) | none |
| request | [ ListChildOrganizationsRequest](#listchildorganizationsrequest) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
...
| address | [ Organization.Address](#organizationaddress) | none |
| contact | [ Organization.Contact](#organizationcontact) | none |
| vat_number | [ string](#string) | none |
| billing_name | [ string](#string) | none |
| billing_address | [ Organization.Address](#organizationaddress) | none |
...
| children | [repeated OrganizationTree](#organizationtree) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| request | [ OrganizationTreeRequest](#organizationtreerequest) | none |
| tree | [ OrganizationTree](#organizationtree) | none |
