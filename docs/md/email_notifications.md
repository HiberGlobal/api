...
- Messages
  ...
  - [EmailNotificationPreferences.CustomRecipient](#emailnotificationpreferencescustomrecipient)
  - [ListEmailNotificationPreferencesRequest](#listemailnotificationpreferencesrequest)
  - [ListEmailNotificationPreferencesRequest.Response](#listemailnotificationpreferencesrequestresponse)
...
### List
> **rpc** List([ListEmailNotificationPreferencesRequest](#listemailnotificationpreferencesrequest))
    [ListEmailNotificationPreferencesRequest.Response](#listemailnotificationpreferencesrequestresponse)
...
| selection | [ EmailHistorySelection](#emailhistoryselection) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| emails | [repeated EmailNotificationHistoryRequest.Response.Email](#emailnotificationhistoryrequestresponseemail) | none |
| request | [ EmailNotificationHistoryRequest](#emailnotificationhistoryrequest) | none |
...
| [**oneof**](https://developers.google.com/protocol-buffers/docs/proto3#oneof) **recipient**.custom | [ EmailNotificationPreferences.CustomRecipient](#emailnotificationpreferencescustomrecipient) | Custom email address. For publishers that send to an email address other than this users' email address. |
| active | [ bool](#bool) | Whether email is active for this user/address. |

### EmailNotificationPreferences.CustomRecipient
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| email_preferences | [repeated EmailNotificationPreferences](#emailnotificationpreferences) | none |
| request | [ ListEmailNotificationPreferencesRequest](#listemailnotificationpreferencesrequest) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
