...
#### This file was generated from [health.proto](https://github.com/HiberGlobal/api/blob/master/health.proto).
...
- Messages
  - [AddHealthLevel](#addhealthlevel)
  - [AddHealthLevel.Request](#addhealthlevelrequest)
  - [AddHealthLevel.Response](#addhealthlevelresponse)
  - [HealthLevel](#healthlevel)
  - [HealthLevel.ColorDataEntry](#healthlevelcolordataentry)
  - [HealthLevelSelection](#healthlevelselection)
  - [ListHealthLevels](#listhealthlevels)
  - [ListHealthLevels.Request](#listhealthlevelsrequest)
  - [ListHealthLevels.Response](#listhealthlevelsresponse)
  - [RemoveHealthLevel](#removehealthlevel)
  - [RemoveHealthLevel.Request](#removehealthlevelrequest)
  - [RemoveHealthLevel.Response](#removehealthlevelresponse)
  - [ReorderHealthLevels](#reorderhealthlevels)
  - [ReorderHealthLevels.Request](#reorderhealthlevelsrequest)
  - [ReorderHealthLevels.Response](#reorderhealthlevelsresponse)
  - [UpdateHealthLevel](#updatehealthlevel)
  - [UpdateHealthLevel.Request](#updatehealthlevelrequest)
  - [UpdateHealthLevel.Request.AddColorsEntry](#updatehealthlevelrequestaddcolorsentry)
  - [UpdateHealthLevel.Response](#updatehealthlevelresponse)
...
### List
> **rpc** List([ListHealthLevels.Request](#listhealthlevelsrequest))
    [ListHealthLevels.Response](#listhealthlevelsresponse)

List the health levels.

### Reorder
> **rpc** Reorder([ReorderHealthLevels.Request](#reorderhealthlevelsrequest))
    [ReorderHealthLevels.Response](#reorderhealthlevelsresponse)

Reorder the health levels, changing the order of severity.

### Add
> **rpc** Add([AddHealthLevel.Request](#addhealthlevelrequest))
    [AddHealthLevel.Response](#addhealthlevelresponse)

Add a new health level at the end of the list (highest severity).

### Update
> **rpc** Update([UpdateHealthLevel.Request](#updatehealthlevelrequest))
    [UpdateHealthLevel.Response](#updatehealthlevelresponse)

Update or rename a health level.

### Remove
> **rpc** Remove([RemoveHealthLevel.Request](#removehealthlevelrequest))
    [RemoveHealthLevel.Response](#removehealthlevelresponse)
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| health_levels | [repeated HealthLevel](#healthlevel) | none |
...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ HealthLevelSelection](#healthlevelselection) | none |
...
| ----- | ---- | ----------- |
| health_levels | [repeated HealthLevel](#healthlevel) | none |
| request | [ ListHealthLevels.Request](#listhealthlevelsrequest) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| reordered_health_levels | [repeated HealthLevel](#healthlevel) | none |
...
| update_color | [ hiber.UpdateClearableString](#hiberupdateclearablestring) | Optionally, set or update the color for this health level. DEPRECATED, use add_colors with name "text". Vice versa, this field will also update the "text" color in the color_data field of HealthLevel. |
