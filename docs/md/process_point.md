...
#### This file was generated from [process_point.proto](https://github.com/HiberGlobal/api/blob/master/process_point.proto).
...
- Messages
  ...
  - [ProcessPoint.AssignedDevice](#processpointassigneddevice)
  - [ProcessPointSelection](#processpointselection)

- Enums
  - [ProcessPoint.Type](#processpointtype)
...
|  **optional** type | [optional ProcessPoint.Type](#processpointtype) | Type of the process point, if any of the predefined types applies. |
...
| devices | [repeated ProcessPoint.AssignedDevice](#processpointassigneddevice) | Devices assigned to this process point |
| inactive_devices | [repeated ProcessPoint.AssignedDevice](#processpointassigneddevice) | Devices that were assigned to this process point in the past |
...
| types | [repeated ProcessPoint.Type](#processpointtype) | Select process points by type. |
