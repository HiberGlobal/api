...
| content_type | [ MQTTPublisher.ContentType](#mqttpublishercontenttype) | none |
...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ MQTTPublisherSelection](#mqttpublisherselection) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| publishers | [repeated MQTTPublisher](#mqttpublisher) | none |
| request | [ DisableMQTTPublisherRequest](#disablemqttpublisherrequest) | none |
...
| ----- | ---- | ----------- |
| publishers | [repeated MQTTPublisher](#mqttpublisher) | none |
| request | [ EnableMQTTPublisherRequest](#enablemqttpublisherrequest) | none |
...
| sort | [repeated ListMQTTPublishersRequest.Sort](#listmqttpublishersrequestsort) | none |
...
| ----- | ---- | ----------- |
| publishers | [repeated MQTTPublisher](#mqttpublisher) | none |
| request | [ ListMQTTPublishersRequest](#listmqttpublishersrequest) | none |
...
| publisher_data | [ MQTTPublisher.Data](#mqttpublisherdata) | none |
...
| data | [ MQTTPublisher.Data](#mqttpublisherdata) | none |
| filter_event_types | [ hiber.Filter.Events](#hiberfilterevents) | none |
| filter_modem_numbers | [ hiber.Filter.Modems](#hiberfiltermodems) | none |
| filter_tags | [ hiber.Filter.Tags](#hiberfiltertags) | none |
| health | [ hiber.Health](#hiberhealth) | none |
| health_config | [ MQTTPublisher.HealthConfig](#mqttpublisherhealthconfig) | none |
...
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| id | [ int64](#int64) | none |
| selection | [ MQTTPublisherHistorySelection](#mqttpublisherhistoryselection) | none |
| pagination | [ hiber.Pagination](#hiberpagination) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| items | [repeated MQTTMessage](#mqttmessage) | none |
| request | [ MQTTPublisherHistoryRequest](#mqttpublisherhistoryrequest) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| mqtt_publishers | [repeated MQTTPublisher](#mqttpublisher) | none |
