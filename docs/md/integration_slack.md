...
| ----- | ---- | ----------- |
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| selection | [ SlackPublisherSelection](#slackpublisherselection) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| publishers | [repeated SlackPublisher](#slackpublisher) | none |
| request | [ DisableSlackPublisherRequest](#disableslackpublisherrequest) | none |
...
| ----- | ---- | ----------- |
| publishers | [repeated SlackPublisher](#slackpublisher) | none |
| request | [ EnableSlackPublisherRequest](#enableslackpublisherrequest) | none |
...
| sort | [repeated ListSlackPublishersRequest.Sort](#listslackpublishersrequestsort) | none |
...
| ----- | ---- | ----------- |
| publishers | [repeated SlackPublisher](#slackpublisher) | none |
| request | [ ListSlackPublishersRequest](#listslackpublishersrequest) | none |
...
| publisher_data | [ SlackPublisher.Data](#slackpublisherdata) | none |
...
| data | [ SlackPublisher.Data](#slackpublisherdata) | none |
| filter_event_types | [ hiber.Filter.Events](#hiberfilterevents) | none |
| filter_modem_numbers | [ hiber.Filter.Modems](#hiberfiltermodems) | none |
| filter_tags | [ hiber.Filter.Tags](#hiberfiltertags) | none |
| filter_health_levels | [repeated string](#string) | Filter events by health level caused. |
| health | [ hiber.Health](#hiberhealth) | none |
| health_config | [ SlackPublisher.HealthConfig](#slackpublisherhealthconfig) | none |
...
| organization | [ string](#string) | Pick the organization to use (/impersonate). If unset, your default organization is used. |
| id | [ int64](#int64) | none |
| selection | [ SlackPublisherHistorySelection](#slackpublisherhistoryselection) | none |
| pagination | [ hiber.Pagination](#hiberpagination) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| items | [repeated SlackMessage](#slackmessage) | none |
| request | [ SlackPublisherHistoryRequest](#slackpublisherhistoryrequest) | none |
| pagination | [ hiber.Pagination.Result](#hiberpaginationresult) | none |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| slack_publishers | [repeated SlackPublisher](#slackpublisher) | none |
